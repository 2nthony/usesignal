...
export interface UseDateFormatOptions {
   ...
   */
  locales?: MaybeSignalOrGetter<Intl.LocalesArgument>
...
function defaultMeridiem(hours: number, _minutes: number, isLowercase?: boolean, hasPeriod?: boolean) {
...
export function useDateFormat(date: MaybeSignalOrGetter<DateLike>, formatStr: MaybeSignalOrGetter<string> = 'HH:mm:ss', options: UseDateFormatOptions = {}) {
  return useComputed(() => formatDate(normalizeDate(toValue(date)), toValue(formatStr), options))
}
